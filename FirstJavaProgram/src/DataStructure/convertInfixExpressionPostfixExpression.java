...
public class convertInfixExpressionPostfixExpression {
	/*
Problem Description
...
Following example demonstrates how to convert an infix to postfix expression by using the concept of stack.
	*/
	...
	public convertInfixExpressionPostfixExpression(String in) {
		input = in;
	...
	public static void main(String[] args) throws IOException {
		...
		String output;
		convertInfixExpressionPostfixExpression theTrans = new convertInfixExpressionPostfixExpression(input);
